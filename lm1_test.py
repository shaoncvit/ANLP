...
class LanguageModelDataset(Dataset):
    def __init__(self, data):
        self.data = [seq for seq in data if len(seq) > 1]
...
def calculate_perplexity(model, loader, criterion, device):
    ...
    return math.exp(total_loss/total_words) if total_words > 0 else float("inf")
...
def main(args):
    ...
    write_perplexity_scores(best_model, train_loader, dictionary, args.train_perplexity_file, device)
    write_perplexity_scores(best_model, test_loader, dictionary, args.test_perplexity_file, device)
...
if __name__ == "__main__":
    ...
    parser.add_argument("--train_perplexity_file", type=str, default="2023701018-LM2-train-perplexity.txt", help="File to save train perplexity scores")
    parser.add_argument("--test_perplexity_file", type=str, default="2023701018-LM2-test-perplexity.txt", help="File to save test perplexity scores")
